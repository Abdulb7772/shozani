    ...
    <section className="relative overflow-hidden bg-navy-950 py-20 sm:py-28">
      ...
      <Container className="relative">
        <SectionHeading
          ...
          title={<>One platform, <span className="text-gradient-gold">every destination</span></>}
          description="A dedicated page for each country with requirements, visa processes, timelines, documents, universities, jobs and country-specific FAQs."
        />
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {countries.map((country, i) => (
            ...
            >
              <Link
                href={country.href}
                className="group relative block overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:border-gold-400/50 hover:bg-white/10"
              >
