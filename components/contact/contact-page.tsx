...
const offices = [
  ...
  { city: "Hannover", country: "Germany", address: "Tempelhofweg 4, 30179 Hannover-Bothfeld-Vahrenheide, Niedersachsen, Germany", phone: "+49 163 4757909" },
];
    ...
    <section className="relative overflow-hidden bg-white pt-16 pb-20 min-h-[560px] sm:pt-24 sm:pb-24 sm:min-h-[640px] dark:bg-navy-950">
      ...
      <Container className="relative">
        ...
        >
          ...
          <span className="text-gold-300">{t("Contact")}</span>
        </motion.nav>
